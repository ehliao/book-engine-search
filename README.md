...
# Description
The task of this challenge requested us to refactor the starter code to be a GraphQL APIL built with Apollo Server. The app will be using the MERN stack with a React front end, MongoDB database and Node.js/Express.js servier and API.
